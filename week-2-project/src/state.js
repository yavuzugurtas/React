...
const Ex8 = function () {
    const [meal, setMeal] = useState('')/* init state and function to update it here */
    return (
        <div>
            <p>I like {meal}</p>
            <button onClick={() => 
...
const Ex9 = function () {
    const [last,setLast] = useState('')/* init state and function to update it here */
    return (
        <div>
            <p>Last click: {last}</p>
            <button  onClick={() => 
